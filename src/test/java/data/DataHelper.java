...
public class DataHelper {
        ...
        public static CardInfo getCardStatusApproved () {
            return new CardInfo("4444444444444441", "05", "23", "Ivanov Ivan", "123");
        }

        public static CardInfo getCardStatusDeclined () {
            return new CardInfo("4444444444444442", "11", "22", "Ivanov Ivan", "123");
        }

        //Проверка поля "номер карты"
        public static CardInfo getCardNumberUnknown () {
            return new CardInfo("4444444444444443", "11", "22", "Ivanov Ivan", "123");
        }
        ...
        public static CardInfo getCardNumber15Numerals () {
            return new CardInfo("444444444444443", "11", "22", "Ivanov Ivan", "123");
        }

        public static CardInfo getCardNumberZeros () {
            return new CardInfo("0000000000000000", "11", "22", "Ivanov Ivan", "123");
        }
        ...
        public static CardInfo getCardMonthEmptyField () {
            return new CardInfo("4444444444444441", "", "22", "Ivanov Ivan", "123");
        }

        public static CardInfo getCardMonthOneNumeral () {
            return new CardInfo("4444444444444441", "3", "22", "Ivanov Ivan", "123");
        }
        ...
        public static CardInfo getCardMonthLetters () {
            return new CardInfo("4444444444444441", "Sы", "22", "Ivanov Ivan", "123");
        }
        ...
        public static CardInfo getCardMonthOver12 () {
            return new CardInfo("4444444444444441", "13", "22", "Ivanov Ivan", "123");
        }

        //Проверка поля "год"
        public static CardInfo getCardYearEmptyField () {
            return new CardInfo("4444444444444441", "10", "", "Ivanov Ivan", "123");
        }

        public static CardInfo getCardYearOneNumeral () {
            return new CardInfo("4444444444444441", "10", "3", "Ivanov Ivan", "123");
        }

        public static CardInfo getCardYearZeros () {
            return new CardInfo("4444444444444441", "10", "00", "Ivanov Ivan", "123");
        }

        public static CardInfo getCardYearOver27 () {
            return new CardInfo("4444444444444441", "10", "45", "Ivanov Ivan", "123");
        }

        public static CardInfo getCardYearLess22 () {
            return new CardInfo("4444444444444441", "10", "20", "Ivanov Ivan", "123");
        }

        public static CardInfo getCardYearText () {
            return new CardInfo("4444444444444441", "10", "Фt", "Ivanov Ivan", "123");
        }
        ...
        public static CardInfo getCardHolderEmptyField () {
            return new CardInfo("4444444444444441", "05", "23", "", "123");
        }

        public static CardInfo getCardHolderNoName () {
            return new CardInfo("4444444444444441", "05", "23", "Ivanov", "123");
        }

        public static CardInfo getCardHolderThreeNames () {
            return new CardInfo("4444444444444441", "05", "23", "Ivanov Ivan Ivan", "123");
        }

        public static CardInfo getCardHolderCyrillic () {
            return new CardInfo("4444444444444441", "05", "23", "Иванов Иван", "123");
        }

        public static CardInfo getCardHolderNumeral () {
            return new CardInfo("4444444444444441", "05", "23", "55587 8888", "123");
        }

        public static CardInfo getCardHolderLettersAndNumbers () {
            return new CardInfo("4444444444444441", "05", "23", "Ivanov56 Ivan", "123");
        }
        ...
        public static CardInfo getCardCvcEmptyField () {
            return new CardInfo("4444444444444441", "05", "23", "Ivanov Ivan", "");
        }

        public static CardInfo getCardCvcZeros () {
            return new CardInfo("4444444444444441", "05", "23", "Ivanov Ivan", "000");
        }

        public static CardInfo getCardCvcOneDigit () {
            return new CardInfo("4444444444444441", "05", "23", "Ivanov Ivan", "1");
        }

        public static CardInfo getCardCvcTwoDigit () {
            return new CardInfo("4444444444444441", "05", "23", "Ivanov Ivan", "23");
        }

        public static CardInfo getCardCvcLetters () {
            return new CardInfo("4444444444444441", "05", "23", "Ivanov Ivan", "ТSы");
        }
